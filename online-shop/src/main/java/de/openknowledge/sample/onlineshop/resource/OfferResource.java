...
public class OfferResource  {
    ...
    public Response createOffer(
        ...
        return seeOther(url.resolve(format("/online-shop/offers/%s/payment", offerNumber.number()))).build();
    }
    ...
    public Response setBillingAddress(
        ...
        return Response.seeOther(url.resolve(format("/online-shop/offers/%s/delivery-address", number.number()))).build();
    }
    ...
    private URI getBillingAddressUri(OrderNumber number) {
        return url.resolve(format("/online-shop/offers/%s/billing-address", number.number()));
    }
}
