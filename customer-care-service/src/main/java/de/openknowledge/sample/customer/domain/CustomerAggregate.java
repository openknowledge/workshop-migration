...
import static de.openknowledge.sample.customer.domain.CustomerAggregate.FIND_BY_CUSTOMER_NUMBER;
...
public class CustomerAggregate {
    ...
    public void setDefaultBillingAddress(Address address) {
    	addAddress(address);
    	this.defaultBillingAddress = find(address).orElseThrow(UnsupportedOperationException::new);
    }
    ...
    public void setDefaultDeliveryAddress(Address address) {
    	addAddress(address);
    	this.defaultDeliveryAddress = find(address).orElseThrow(UnsupportedOperationException::new);
    }
    ...
    public void addAddress(Address address) {
    	...
    	} else if (find(address).isEmpty()) {
    		addresses.add(new AddressEntity(this, address));
    	}
    }

    private Optional<AddressEntity> find(Address address) {
    	if (addresses == null) {
