 ...
 */
package de.openknowledge.sample.checkout.domain.customer;
...
import de.openknowledge.sample.checkout.domain.customer.CustomerNumber.Adapter;
import de.openknowledge.sample.checkout.infrastructure.jsonb.AbstractRecordValueTypeAdapter;

@JsonbTypeAdapter(Adapter.class)
public record CustomerNumber(@NotNull @Pattern(regexp = "\\d+") String number) {
